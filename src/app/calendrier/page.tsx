      ...
      <div className="relative p-4 sm:p-5">
        ...
        <div className="flex items-start justify-between gap-3 mb-4">
          ...
          <div className="flex flex-col items-end gap-1 flex-shrink-0">
            {isToday && (
              <span className="px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider bg-blue-500/20 text-blue-300 border border-blue-500/30 rounded-full animate-pulse whitespace-nowrap">
                {t.today}
              </span>
            )}
            <span
