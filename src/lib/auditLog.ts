...
export function formatAuditLogDisplay(log: any): string {
  const actionMap: Record<string, string> = {
    ...
    all_stats_reset: "reset all statistics",
    database_reset: "reset entire database",
