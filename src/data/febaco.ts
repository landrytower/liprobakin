...
export const spotlightPlayers: SpotlightPlayer[] = [
  ...
  },
  {
    ...
    position: "F",
    team: "Ballers",
    stats: "22.1 PPG | 6.4 REB",
    efficiency: "+14.1",
    blurb: "Boteya's downhill slashing and pull-up rhythm give Ballers a nightly advantage on the wing.",
    number: 9,
    statLines: [
      { label: "Points", value: "22.1" },
      { label: "Rebounds", value: "6.4" },
      { label: "Assists", value: "3.1" },
    ...
    photo: "/players/abel-boteya.jpeg",
  },
  {
    name: "Serge Mapendo",
    position: "C",
